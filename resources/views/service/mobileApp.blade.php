...
@section('content')
    ...
    <div class="rbt-admission-area bg-color-white rbt-section-gapTop">
        <div class="container" data-sal-delay="300" data-sal="slide-up" data-sal-duration="600">
            <div class="row g-5">
                <div class="col-12">
            ...
            <div class="text-center">
                <a href="#" class="rbt-video-popup rbt-popup-youtube">
                    <img src="{{ asset('assets/images/icons/googlePlay.png') }}" alt="Google Play" class="googlePlay"
    ...
    <div class="rbt-about-area about-style-1 bg-color-white rbt-section-gapBottom">
        <div class="container">
            ...
            <div class="row g-5 align-items-center mg-y">
                <div class="col-lg-6" data-sal-delay="100" data-sal="slide-right" data-sal-duration="600">
                    <div class="content">
                        <img src="{{ asset('assets/images/service/mobile-1.webp') }}" alt="MT5 Images">
                    </div>
                </div>
                <div class="col-lg-6" data-sal-delay="300" data-sal="slide-left" data-sal-duration="600">
                    <div class="inner pl--50 pl_sm--5">
                        <div class="content text-start">
                            <h3 class="title">Access 1,000+ Global Markets</h3>
                            <p class="rbt-card-text" style="font-size: 18px;">
                                From stocks and indices to commodities, ETFs, and forex—trade your favorite assets anytime,
                                anywhere.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row g-5 align-items-center mg-y">
                <div class="col-lg-6" data-sal-delay="300" data-sal="slide-right" data-sal-duration="600">
                    <div class="inner pl--50 pl_sm--5">
                        ...
                        <div class="content text-start">
                            <h3 class="title">Daily News & Expert Insights</h3>
                            <p class="rbt-card-text" style="font-size: 18px;">
                                Stay ahead of market trends with integrated news, daily commentary, and a full economic
                                calendar—right inside the app.
                            </p>
                            <br />
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-sal-delay="100" data-sal="slide-left" data-sal-duration="600">
                    <div class="content text-center">
                        <img src="{{ asset('assets/images/service/mobile-2.png') }}" alt="MT5 Images">
                    </div>
                </div>
            </div>
            <!-- End Single Section  -->
            ...
            <div class="row g-5 align-items-center mg-y">
                <div class="col-lg-6" data-sal-delay="100" data-sal="slide-right" data-sal-duration="600">
                    <div class="content">
                        <img src="{{ asset('assets/images/service/mobile-3.png') }}" alt="MT5 Images">
                    </div>
                </div>
                <div class="col-lg-6" data-sal-delay="300" data-sal="slide-left" data-sal-duration="600">
                    <div class="inner pl--50 pl_sm--5">
                        ...
                        <div class="content text-start">
                            <h3 class="title">Custom Watchlists & Real-Time Alerts</h3>
                            <p class="rbt-card-text" style="font-size: 18px;">
                                Track what matters to you. Set personalized watchlists and get instant push notifications
                                when market conditions meet your strategy.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5 align-items-center mg-y">
                <div class="col-lg-6" data-sal-delay="300" data-sal="slide-right" data-sal-duration="600">
                    <div class="inner pl--50 pl_sm--5">
                        ...
                        <div class="content text-start">
                            <h3 class="title">Effortless Account Management</h3>
                            <p class="rbt-card-text" style="font-size: 18px;">
                                Deposit, withdraw, and track trade performance with ease. Secure and fast transactions
                                ensure you're always ready to act.
                            </p>
                            <br />
                        </div>
                    </div>
                ...
                <div class="col-lg-6" data-sal-delay="100" data-sal="slide-left" data-sal-duration="600">
                    <div class="content text-center">
                        <img src="{{ asset('assets/images/service/mobile-4.png') }}" alt="MT5 Images">
                    </div>
                </div>
            </div>
            <!-- End Single Section  -->
    ...
    <div class="rbt-call-to-action-area bg-color-light">
                        ...
                        <div class="rbt-cta-5">
                            <div class="content">
                                ...
                                <div style="text-align: left;">
                                    ...
                                    <a href="#" class="rbt-video-popup rbt-popup-youtube">
                                        <svg id="livetype" xmlns="http://www.w3.org/2000/svg" width="170.66407"
                                            height="72" viewBox="0 0 119.66407 40">
                                            <g>
                                                <g>
                                                    <g>
                                                        <path
